...
confidenceText: { color: "#f97316", fontWeight: "700", fontSize: 12 },

cardMeta: { flexDirection: "row", gap: 20, alignItems: "center" },
metaItem: { gap: 2 },
...
openBtnText: { color: "rgba(255,255,255,0.85)", fontWeight: "700", fontSize: 13 },
dupBtn: {
flex: 1,
height: 40,
borderRadius: 10,
...
dupBtnText: { color: "rgba(255,255,255,0.55)", fontWeight: "700", fontSize: 13 },
shareBtn: {
flex: 1,
height: 40,
borderRadius: 10,
...
clearText: { color: "rgba(255,255,255,0.55)", fontWeight: "700", fontSize: 15 },
...
selectModeBtnText: { color: "rgba(255,255,255,0.55)", fontWeight: "700", fontSize: 13 },
...
exportSelectedText: { color: "#07152b", fontWeight: "900", fontSize: 15 },
