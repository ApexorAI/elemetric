...
const styles = StyleSheet.create({
  ...
  infoLabel: { color: "rgba(255,255,255,0.40)", fontSize: 12, marginTop: 4 },
  infoValue: { color: "white", fontSize: 15, fontWeight: "700" },

  fieldLabel: { color: "rgba(255,255,255,0.50)", fontSize: 13, marginTop: 4 },
  input: {
    borderRadius: 10,
    borderWidth: 1,
    borderColor: "rgba(255,255,255,0.10)",
  ...
  checkLabel: { color: "white", fontSize: 14, fontWeight: "700", lineHeight: 20 },
  ...
  sBtnPass: { backgroundColor: "rgba(22,163,74,0.18)", borderColor: "#16a34a" },
  sBtnFail: { backgroundColor: "rgba(220,38,38,0.18)", borderColor: "#dc2626" },
  sBtnNA:   { backgroundColor: "rgba(107,114,128,0.18)", borderColor: "#6b7280" },
  statusBtnText: { color: "rgba(255,255,255,0.5)", fontSize: 13, fontWeight: "700" },
  ...
  photoThumb: { width: 72, height: 72, borderRadius: 8, backgroundColor: "rgba(255,255,255,0.06)" },
  removeOverlay: {
    position: "absolute",
    top: 2,
    right: 2,
  ...
  addPhotoText: { color: "#f97316", fontSize: 12, fontWeight: "700" },

  aiDesc: { color: "rgba(255,255,255,0.50)", fontSize: 13, lineHeight: 19 },
  aiResult: {
    borderRadius: 12,
    borderWidth: 1,
  ...
  aiConfidence: { color: "#f97316", fontSize: 36, fontWeight: "900" },
  aiConfidenceLabel: { color: "rgba(255,255,255,0.50)", fontSize: 12 },
  aiAction: { color: "white", fontSize: 13, fontWeight: "700", marginTop: 4 },
  aiAnalysis: { color: "rgba(255,255,255,0.60)", fontSize: 13, lineHeight: 19 },
  actionBtn: {
    borderRadius: 12,
    paddingVertical: 13,
    alignItems: "center",
  ...
  actionBtnText: { color: "#0b1220", fontWeight: "900", fontSize: 15 },
  ...
  declCheckActive: { backgroundColor: "#16a34a", borderColor: "#16a34a" },
  declCheckMark: { color: "white", fontSize: 13, fontWeight: "900" },
  declText: { color: "rgba(255,255,255,0.75)", fontSize: 13, lineHeight: 20, flex: 1 },
  declWarning: { color: "#f97316", fontSize: 12, fontStyle: "italic" },
