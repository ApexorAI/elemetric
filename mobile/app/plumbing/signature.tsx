...
const styles = StyleSheet.create({
  ...
  previewSvgNote: { color: "rgba(255,255,255,0.40)", fontSize: 12 },
  previewClose: { color: "rgba(255,255,255,0.45)", fontWeight: "700", fontSize: 13, textAlign: "center" },
  ...
  padDate: { color: "rgba(255,255,255,0.40)", fontSize: 11 },
  padStrokeCount: { color: "rgba(255,255,255,0.30)", fontSize: 11 },
  ...
  padActionText: { color: "rgba(255,255,255,0.70)", fontWeight: "700", fontSize: 13 },
  ...
  toggleInfo: { flex: 1 },
  toggleLabel: { color: "white", fontWeight: "700", fontSize: 14 },
  toggleSub: { color: "rgba(255,255,255,0.45)", fontSize: 12, marginTop: 2 },
  ...
  hintText: { color: "#f97316", fontSize: 13, lineHeight: 18 },
