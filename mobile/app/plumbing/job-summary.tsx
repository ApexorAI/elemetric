...
const styles = StyleSheet.create({
  ...
  gaugeLabel: { color: "rgba(255,255,255,0.55)", fontSize: 12, marginTop: 1 },
  riskBanner: {
    borderRadius: 20,
    borderWidth: 1,
    paddingVertical: 4,
  ...
  riskText: { fontWeight: "700", fontSize: 15, letterSpacing: 1 },
  card: {
    backgroundColor: "#0f2035",
    borderRadius: 16,
    borderWidth: 1,
  ...
  photoLabel: { color: "white", fontWeight: "700", fontSize: 15 },
  photoRole: { color: "rgba(255,255,255,0.55)", fontSize: 13 },
  statusBadge: {
    flexDirection: "row",
    alignItems: "center",
    gap: 5,
  ...
  statusIcon: { fontWeight: "700", fontSize: 12 },
  ...
  actionIcon: { fontWeight: "700", fontSize: 14, marginTop: 1 },
  actionText: {
    flex: 1,
  ...
  allClearTitle: { color: "#22c55e", fontWeight: "900", fontSize: 22 },
  allClearBody: {
    color: "rgba(255,255,255,0.55)",
    fontSize: 13,
    textAlign: "center",
  ...
  retakeBtnText: { color: "white", fontWeight: "700", fontSize: 15 },
  proceedBtn: {
