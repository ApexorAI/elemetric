...
<div style="font-size:14px;font-weight:bold;">Drainage Compliance Report · AS/NZS 3500</div>
...
${aiSection}
<div style="margin-bottom:16px;">
<div style="font-size:19px;font-weight:bold;margin-bottom:10px;">Drainage Checks</div>
<table style="width:100%;border-collapse:collapse;">
<tr>
...
if (canShare) {
await Sharing.shareAsync(uri, { mimeType: "application/pdf", dialogTitle: "Share Drainage Report", UTI: "com.adobe.pdf" });
} else {
