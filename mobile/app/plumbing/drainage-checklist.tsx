...
sectionSub:   { color: "rgba(255,255,255,0.55)", fontSize: 13, marginTop: -4 },
fieldLabel: {
...
chip: { paddingHorizontal: 14, paddingVertical: 8, borderRadius: 20, borderWidth: 1, borderColor: "rgba(255,255,255,0.10)", backgroundColor: "rgba(255,255,255,0.06)" },
chipActive: { borderColor: "#f97316", backgroundColor: "#f97316" },
chipPass: { borderColor: "#22c55e", backgroundColor: "rgba(34,197,94,0.10)" },
chipFail: { borderColor: "#ef4444", backgroundColor: "rgba(239,68,68,0.10)" },
chipText: { color: "rgba(255,255,255,0.55)", fontWeight: "500", fontSize: 13 },
chipTextActive: { color: "#07152b", fontWeight: "700" },
chipPassText: { color: "#22c55e", fontWeight: "700" },
chipFailText: { color: "#ef4444", fontWeight: "700" },
input: {
backgroundColor: "#0f2035",
borderRadius: 12,
padding: 14,
...
gpsBtnText: { color: "rgba(255,255,255,0.85)", fontWeight: "700", fontSize: 15 },
...
aiCardLabel: { color: "rgba(255,255,255,0.55)", fontWeight: "700", fontSize: 13 },
aiScore: { color: "#22c55e", fontSize: 44, fontWeight: "900" },
aiAction: { color: "#f97316", fontWeight: "700", fontSize: 15 },
aiListGreen: { color: "#22c55e", fontWeight: "700", fontSize: 13, marginTop: 4 },
aiListRed: { color: "#ef4444", fontWeight: "700", fontSize: 13, marginTop: 4 },
