...
const styles = StyleSheet.create({
  ...
  exportSub: { color: "rgba(255,255,255,0.40)", fontSize: 12, marginTop: 2 },
  exportBtn: {
  ...
  rowSub: { color: "rgba(255,255,255,0.40)", fontSize: 12, marginTop: 2 },
  ...
  infoTitle: { color: "white", fontWeight: "800", fontSize: 14, marginBottom: 4 },
  ...
  deletionTitle: { color: "#ef4444", fontWeight: "900", fontSize: 16 },
