...
const styles = StyleSheet.create({
  ...
  weekLabel: { color: "rgba(255,255,255,0.6)", fontSize: 13, fontWeight: "700" },

  dayRow: { paddingHorizontal: 14, paddingBottom: 10, gap: 8 },
  dayChip: {
    width: 48,
    borderRadius: 14,
    paddingVertical: 10,
  ...
  dayDotSelected: { backgroundColor: "#0b1220" },
  ...
  emptyTitle: { color: "white", fontSize: 16, fontWeight: "900" },
  ...
  cardTitles: { flex: 1 },
  jobTitle: { color: "white", fontWeight: "900", fontSize: 16 },
  jobAddr: { color: "rgba(255,255,255,0.55)", fontSize: 12, marginTop: 2 },
  statusBadge: { borderRadius: 8, paddingHorizontal: 9, paddingVertical: 3, borderWidth: 1 },
  statusBadgeText: { fontSize: 10, fontWeight: "900" },
  cardMeta: { flexDirection: "row", gap: 20 },
  metaItem: { gap: 2 },
  metaKey: { color: "rgba(255,255,255,0.4)", fontSize: 10, fontWeight: "800" },
  metaVal: { color: "rgba(255,255,255,0.85)", fontSize: 13, fontWeight: "700" },
  tapHint: { color: "rgba(249,115,22,0.7)", fontSize: 11, fontWeight: "700" },
  ...
  memberName: { color: "white", fontWeight: "700", fontSize: 14 },
  ...
  saveBtnText: { color: "#0b1220", fontWeight: "900", fontSize: 15 },
