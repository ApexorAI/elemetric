...
const styles = StyleSheet.create({
  ...
  memberStatLabel: { color: "rgba(255,255,255,0.40)", fontSize: 11, fontWeight: "700" },
  memberStatValue: { color: "white", fontSize: 15, fontWeight: "900" },
  ...
  pdfBtnText: { color: "white", fontWeight: "900", fontSize: 16 },
