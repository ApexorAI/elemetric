...
const styles = StyleSheet.create({
  ...
  sendBtnText: { color: "#07152b", fontWeight: "900", fontSize: 15 },
  ...
  inviteEmail: { color: "white", fontSize: 15, fontWeight: "700" },
  inviteDate: { color: "rgba(255,255,255,0.55)", fontSize: 13 },
