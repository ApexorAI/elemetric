...
const styles = StyleSheet.create({
  ...
  bubbleTimeOwn: { color: "rgba(249,115,22,0.55)" },
  ...
  sendBtnDisabled: { backgroundColor: "rgba(249,115,22,0.25)" },
  sendBtnText: { color: "#07152b", fontWeight: "900", fontSize: 18, marginTop: -1 },
